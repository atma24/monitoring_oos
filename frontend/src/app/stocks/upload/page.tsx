...
export default function StockUploadPage() {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      const res = await api.post('/stock-records/upload', form, { headers: { 'Content-Type': 'multipart/form-data' } });
      ...
      <div className="max-w-2xl mx-auto space-y-6 pt-8">
        ...
        <div className="bg-white rounded-3xl p-8 shadow-sm">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <h2 className="text-xl font-bold text-gray-800">Upload Stok Preventif</h2>
              <p className="text-sm text-gray-500">File Excel OOS Preventif (.xlsx, .xls, .csv)</p>
            </div>
          </div>
